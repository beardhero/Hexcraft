...
export declare type FilterCallback<T extends Schema = any, V = any, R extends Schema = any> = (((this: T, client: Client, value: V) => boolean) | ((this: T, client: Client, value: V, root: R) => boolean));
export declare type FilterChildrenCallback<T extends Schema = any, K = any, V = any, R extends Schema = any> = (((this: T, client: Client, key: K, value: V) => boolean) | ((this: T, client: Client, key: K, value: V, root: R) => boolean));
